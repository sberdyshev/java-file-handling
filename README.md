...
Примеры комманд (символы "_" должны быть заменены на пробелы):

`"COMMAND,____AUTH_REQUEST,_______________anton,____________password,1.0.0.,____________________"`

`"COMMAND,_____DELETE_FILE,_marina.panova@ya.ru,____________________,2.1.8.,____________file.txt"`
