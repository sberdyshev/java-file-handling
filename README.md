...
- [2. Реализация](#2-реализация)
  - [2.1. MVP](#21-mvp)
    ...
    - [2.1.2. Реализация функциональных требований](#212-реализация-функциональных-требований)
      - [2.1.2.1. Аутентификация](#2121-аутентификация)
      - [2.1.2.2. Удаление файла с сервера](#2122-удаление-файла-с-сервера)
      - [2.1.2.3. Получение файла с сервера](#2123-получение-файла-с-сервера)
      - [2.1.2.4. Получение списка файлов с сервера](#2124-получение-списка-файлов-с-сервера)
      - [2.1.2.5. Запись файла на сервер](#2125-запись-файла-на-сервер)
...
###### 2.1.2.1.1. Формат команды аутентификации

Количество символов  | Обязательность поля | Описание
--|---|--
7  | Обязательное  |  константа "COMMAND"
15  | Обязательное  |  тип команды. Заполняется значением "____AUTH_REQUEST" (символы "_" должны быть заменены на пробелы)
20  |  Обязательное |  логин пользователя
...
###### 2.1.2.2.1. Формат команды "удаление файла с сервера"

Количество символов  | Обязательность поля | Описание
--|---|--
7  | Обязательное  |  константа "COMMAND"
15  | Обязательное  |  тип команды. Заполняется значением "_____DELETE_FILE" (символы "_" должны быть заменены на пробелы)
20  |  Обязательное |  логин пользователя
...
###### 2.1.2.3.1. Формат команды "получение файла с сервера"

Количество символов  | Обязательность поля | Описание
--|---|--
7  | Обязательное  |  константа "COMMAND"
15  | Обязательное  |  тип команды. Заполняется значением "______FETCH_FILE" (символы "_" должны быть заменены на пробелы)
20  |  Обязательное |  логин пользователя
20  | Не заполняется  |  пароль пользователя (будет проигнорировано)
6  |  Обязательное |  версия сервиса в формате Х.Y.Z.
20  | Обязательное  |  имя файла
...
###### 2.1.2.4.1. Формат команды "получение списка файлов с сервера"

Количество символов  | Обязательность поля | Описание
--|---|--
7  | Обязательное  |  константа "COMMAND"
15  | Обязательное  |  тип команды. Заполняется значением "FETCH_FILE_LIST" (символы "_" должны быть заменены на пробелы)
20  |  Обязательное |  логин пользователя
20  | Не заполняется  |  пароль пользователя (будет проигнорировано)
6  |  Обязательное |  версия сервиса в формате Х.Y.Z.
...
###### 2.1.2.4.1. Формат команды "запись файла на сервер"
